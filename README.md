Open the application in VS and run the project ones, after that you can close it. It must have created .exe file in the bin folder so now you will be able to start two instances for chat. 
